...
local vanSpawnLocation = vector3(60.72, 124.28, 79.23) -- Set the specific location for van spawn
local vanSpawnHeading = 153.89 -- Set the heading for the spawned van
local jobEndLocation = vector3(74.54, 122.46, 79.2) -- Marker for ending the job
...
local payPerDelivery = 12 -- Set payment per delivery
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        -- Draw 3D marker for ending the job only when the job is active
